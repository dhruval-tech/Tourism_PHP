...
<body text="black" class="background_image" style="background-image:url('static/images/book.jpg')">
    ...
    <div >
		<h1><center><font color="black">Login</font></center></h1>
		<center><form  action="validation.php" method="POST"  >
        
		<table bgcolor=#A3A8A7 align="center" width="500" height="40">
			...
			<tr>
                ...
                <td><input type="password" name="password"  pattern=".{8,11}" placeholder="minimum length of 8"    id="pass" required="required"></td>
			</tr>

            <tr>
				<td height="60" ><font color="black"><center><input type="submit" ></center></font></td>
				<td ><font color="black"><a href="registration.php"><b>New user?</b></a></font></td>
			</tr>
</table>
	</form>
