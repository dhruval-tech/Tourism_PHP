...
<html len="en">
    ...
    <body>
        <table>
            <tr><h1 align="center" size="50" style="color:BROWN ;font-size:300%"><b><strong><marquee>The Best Places to visit in South India</marquee></strong></b></h1></tr><br>
        <tr><h2 align="center"><img align="middle" src="static/images/south-images/1024px-Gavi_elephants_2.jpg" height="500"></h2></tr>
        <tr><P style="color:blue;text-align:center;font-size:150%;font-family:Optima;margin:3em "><b>There is just one time in your life when you have time, energy and money (okay, not heaps, but bundles at least? small bundles?) to spend and in these times, you’re all pumped up. C’mon world. Bring it on. Listen up adventure squad and quiet time maniacs, there’s something here for all of you :)
            </b>
</P></tr><br>
        <tr><th><h4 style="color:brown;text-align:left;font-size:200% "><u>COORG</u></h4></th></tr>
        <tr><th><img align="left" src="static/images/south-images/vihigaon.jpg" height="400"></th><br>
        <th><p style="text-align:right;font-size:170%;font-family:Candara">Widely known for being the “Scotland of the South”, Coorg is an enchanting hill station located not so far from Bangalore. The view of the grey clouds subtly blending with the greenery of the hills is a sight worth seeing. Ever tried waterfall rappelling? If not, now is the time! An exciting challenge to overcome, with the water flowing down with force, in a moist climate, hear your heartbeat in your ears. Over the sound of the waterfall. There is no better place for this than Coorg, which easily makes it to the list of best places to visit in South India.
